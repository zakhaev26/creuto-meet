...
export const CreateMeetingParticipantValidation = z.object({
...
export const PatchMeetingParticipantValidation = z.object({
  name: z.string().optional(),
  updatedAt: z.date().optional(),
  createdAt: z.date().optional(),
...
export const RemoveMeetingParticipantValidation = z.object({
